    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tenancies", x => x.TenancyId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusUpdate = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaintenanceUpdates", x => x.UpdateId);
                    table.ForeignKey(
                        name: "FK_MaintenanceUpdates_AspNetUsers_StaffId",
                        column: x => x.StaffId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceUpdates_MaintenanceRequests_RequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceUpdates_StaffId",
                table: "MaintenanceUpdates",
                column: "StaffId");
